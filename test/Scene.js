...
describe('Scene', function() {
	...
	context('setQuestion', function() {
		...
		it('should set the question of the Scene to the given question', function() {
			const scene = Scene()('Question', ['Required character'], ['Forbidden character'], 'Frame', 'Answer');
			const result = scene.setQuestion('New question');
			result.should.deep.equal(Scene(scene.id)('New question', ['Required character'], ['Forbidden character'], 'Frame', 'Answer'));
		});
	...
	context('requireCharacter', function() {
		...
		it('should have the required character after requiring a character on a Scene where there was none', function() {
			...
			const scene = Scene()('Question', [], ['Forbidden character'], 'Frame', 'Answer');
			const result = scene.requireCharacter(character);
			result.should.deep.equal(Scene(scene.id)('Question', [character], ['Forbidden character'], 'Frame', 'Answer'));
		});
		...
		it('should have both required characters after requiring a character on a Scene where there was one', function() {
			...
			const scene = Scene()('Question', [character1], ['Forbidden character'], 'Frame', 'Answer');
			const result = scene.requireCharacter(character2);
			result.should.deep.equal(Scene(scene.id)('Question', [character1, character2], ['Forbidden character'], 'Frame', 'Answer'));
		});
		...
		it('should throw when thying to require a character on a Scene where there was already two', function() {
			...
			const scene = Scene()('Question', [character1, character2], ['Forbidden character'], 'Frame', 'Answer');
	...
	context('freeCharacter', function() {
		...
		it('should remove the freed character from the required characters when it was required on the Scene', function() {
			const scene = Scene()('Question', ['First required character', 'Second required character'], ['Forbidden character'], 'Frame', 'Answer');
			const result = scene.freeCharacter('First required character');
			result.should.deep.equal(Scene(scene.id)('Question', ['Second required character'], ['Forbidden character'], 'Frame', 'Answer'));
		});
	...
	context('forbidCharacter', function() {
		...
		it('should have the forbidden character when there was none in the Scene', function() {
			const scene = Scene()('Question', ['Required character'], [], 'Frame', 'Answer');
		...
		it('should have the forbidden character when there was already one in the Scene', function() {
			const scene = Scene()('Question', ['Required character'], ['First forbidden character'], 'Frame', 'Answer');
			const result = scene.forbidCharacter('Second forbidden character');
			result.should.deep.equal(Scene(scene.id)('Question', ['Required character'], ['First forbidden character', 'Second forbidden character'], 'Frame', 'Answer'));
		});

		it('should throw when there was already two forbidden characters in the Scene', function() {
			const scene = Scene()('Question', ['Required character'], ['First forbidden character', 'Second forbidden character'], 'Frame', 'Answer');
	...
	context('allowCharacter', function() {
		...
		it('should remove the allowed character from the forbidden characters when it was forbidden on the Scene', function() {
			...
			result.should.deep.equal(Scene(scene.id)('Question', ['Required character'], ['Second forbidden character'], 'Frame', 'Answer'));
		});
	...
	context('setupFrame', function() {
		...
		it('should setup the frame of a Scene when there was none', function() {
			const scene = Scene()('Question', ['Required character'], ['Forbidden character'], undefined, 'Answer');
			const result = scene.setupFrame('Frame description');
			result.should.deep.equal(Scene(scene.id)('Question', ['Required character'], ['Forbidden character'], 'Frame description', 'Answer'));
		});

		it('should setup the frame of a Scene when there was already one', function() {
			const scene = Scene()('Question', ['Required character'], ['Forbidden character'], 'Old frame', 'Answer');
			const result = scene.setupFrame('Frame description');
			result.should.deep.equal(Scene(scene.id)('Question', ['Required character'], ['Forbidden character'], 'Frame description', 'Answer'));
		});
	...
	context('setAnswer', function() {
		...
		it('should set the answer to the question of a Scene when there was already one', function() {
			...
			result.should.deep.equal(Scene(scene.id)('Question', ['Required character'], ['Forbidden character'], 'Frame', 'New answer'));
		});
